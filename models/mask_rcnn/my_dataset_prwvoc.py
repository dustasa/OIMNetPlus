...
class PRW_VOCInstances(Dataset):
    def __init__(self, voc_root, year="2012", txt_name: str = "train.txt", transforms=None):
        ...
        # read class_indict
        json_file = 'prw_voc_indices.json'
        ...
        masks_path = [os.path.join(mask_dir, x + "_mask.png") for x in file_names]
...
if __name__ == '__main__':
    dataset = VOCInstances(voc_root="/home/aousn/git-repo/pytorch_object_detection/data/PRW_VOC")
    print(len(dataset))
    d1 = dataset[0]
