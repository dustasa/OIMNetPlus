...
def create_model(num_classes, load_pretrain_weights=True):
    ...
    backbone = resnet50_fpn_backbone(pretrain_path="/home/aousn/git-repo/person_search/person_search/pth/resnet50.pth",
                                     trainable_layers=3)
    ...
    if load_pretrain_weights:
        ...
        weights_dict = torch.load("/home/aousn/git-repo/person_search/person_search/pth/maskrcnn_resnet50_fpn_coco.pth",
                                  map_location="cpu")
