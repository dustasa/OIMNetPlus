...
def main(parser_data):
    ...
    val_dataset = PRW_VOCInstances(data_root, year="2012", txt_name="val.txt", transforms=data_transform["val"])
    ...
    det_metric = EvalCOCOMetric(val_dataset.coco, "bbox", "exps/prw_voc_0919/det_results.json")
    seg_metric = EvalCOCOMetric(val_dataset.coco, "segm", "exps/prw_voc_0919/seg_results.json")
    model.eval()
    with torch.no_grad():
...
if __name__ == "__main__":
    ...
    # 类别索引和类别名称对应关系
    parser.add_argument('--label-json-path', type=str, default="prw_voc_indices.json")
